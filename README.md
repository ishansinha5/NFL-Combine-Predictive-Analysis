...
You can easily clone this repo and run your own teams through the pipeline. 
...
3. **Add your team:** Manually add the players your team drafted using the format: Team Name, Player Name, Position, College. (Note: Ensure the player's name is spelled exactly as it appears in standard NFL Combine databases).
...
To generate Franchise evaluations: `python team_grader.py`
To generate Positional evaluations: `python position_grader.py`

By default, the pipeline runs in Normalized Mode. To evaluate players based on raw career longevity rather than per-season impact, append cumulative to the commands:
